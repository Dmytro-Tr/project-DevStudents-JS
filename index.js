import{S as j,A as R,a as q,N as x,K as C,i as I,b as k}from"./assets/vendor-Czw9bCZh.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function o(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(t){if(t.ep)return;t.ep=!0;const n=o(t);fetch(t.href,n)}})();const b=document.documentElement,m=document.getElementById("theme-switcher"),u=localStorage.getItem("theme");u&&(b.setAttribute("data-theme",u),m.checked=u==="dark");m.addEventListener("change",()=>{const e=m.checked?"dark":"light";b.setAttribute("data-theme",e),localStorage.setItem("theme",e)});const U=document.querySelector(".header__toggle-btn"),N=document.querySelector(".nav");document.addEventListener("DOMContentLoaded",function(){const e=document.querySelectorAll('a[href^="#"]');for(let s of e)s.addEventListener("click",function(o){o.preventDefault();const r=this.getAttribute("href").substring(1);document.getElementById(r).scrollIntoView({behavior:"smooth",block:"start"})})});U.addEventListener("click",function(){this.classList.toggle("is-active"),N.classList.toggle("is-open"),document.documentElement.classList.toggle("no-scroll")});let _=window.scrollY;const a=document.querySelector("header");window.addEventListener("scroll",()=>{window.scrollY>_?(a.style.transform="translateY(-100%)",a.classList.remove("scroll")):(a.style.transform="translateY(0)",a.classList.add("scroll")),window.scrollY===0&&(a.style.transform="translateY(0)",a.classList.remove("scroll")),_=window.scrollY});new j(".hero__slider",{modules:[R],slidesPerView:1,autoHeight:!0,loop:!0});function y(e){const s=document.getElementById(e),o=s.querySelector(".skills__inner");for(let t=0;t<4;t++){const n=o.cloneNode(!0);s.appendChild(n)}const r=()=>{const t=o.offsetWidth;s.style.width=`${t*5}px`};window.addEventListener("load",r),window.addEventListener("resize",r)}document.addEventListener("DOMContentLoaded",()=>{y("top-skills"),y("bottom-skills")});new q(".faq__accordion-container",{openOnInit:[0],collapse:!1,elementClass:"faq__acc-item",triggerClass:"faq__acc-trigger",panelClass:"faq__acc-panel"});const S=[{title:"power pulse webservice",techStack:"React, JavaScript, Node JS, Git",images:{regular:new URL("/project-DevStudents-JS/assets/power-pulse-1x-acMDRKKi.jpg",import.meta.url).href,retina:new URL("/project-DevStudents-JS/assets/power-pulse-2x-ZP1rUwJ6.jpg",import.meta.url).href},link:"#"},{title:"vyshyvanka vibes Landing page",techStack:"React, JavaScript, Node JS, Git",images:{regular:new URL("/project-DevStudents-JS/assets/vyshyvanka-1x-wHj5BVEI.jpg",import.meta.url).href,retina:new URL("/project-DevStudents-JS/assets/vyshyvanka-2x-Bw30tzD2.jpg",import.meta.url).href},link:"#"},{title:"energy flow webservice",techStack:"React, JavaScript, Node JS, Git",images:{regular:new URL("/project-DevStudents-JS/assets/energy-flow-1x-DXN7nhJD.jpg",import.meta.url).href,retina:new URL("/project-DevStudents-JS/assets/energy-flow-2x-DnFIyAp2.jpg",import.meta.url).href},link:"#"},{title:"mimino website",techStack:"React, JavaScript, Node JS, Git",images:{regular:new URL("/project-DevStudents-JS/assets/mimino-1x-DfqnBMXG.jpg",import.meta.url).href,retina:new URL("/project-DevStudents-JS/assets/mimino-2x-Cda9-ebG.jpg",import.meta.url).href},link:"#"},{title:"chego jewelry website",techStack:"React, JavaScript, Node JS, Git",images:{regular:new URL("/project-DevStudents-JS/assets/chego-jewelry-1x-DslUanu5.jpg",import.meta.url).href,retina:new URL("/project-DevStudents-JS/assets/chego-jewelry-2x-CeDm7Ud8.jpg",import.meta.url).href},link:"#"},{title:"fruitbox online store",techStack:"React, JavaScript, Node JS, Git",images:{regular:new URL("/project-DevStudents-JS/assets/fruitbox-1x-FvtoJi5e.jpg",import.meta.url).href,retina:new URL("/project-DevStudents-JS/assets/fruitbox-2x-Crz6mVAG.jpg",import.meta.url).href},link:"#"},{title:"starlight studio landing page",techStack:"React, JavaScript, Node JS, Git",images:{regular:new URL("/project-DevStudents-JS/assets/starlight-1x-qCKERloI.jpg",import.meta.url).href,retina:new URL("/project-DevStudents-JS/assets/starlight-2x-DajCcANY.jpg",import.meta.url).href},link:"#"}],$=document.querySelector(".project__list"),w=document.getElementById("load-more"),h=document.getElementById("hide-projects");w.addEventListener("click",P);h.addEventListener("click",B);let l=0;function A(e){const s=new URL("/project-DevStudents-JS/assets/icons-CYC6FQL3.svg",import.meta.url).href;return`
  ...
  `}function P(){const e=S.slice(l,l+3);e.forEach(s=>{const o=A(s);$.insertAdjacentHTML("beforeend",o)}),l+=e.length,l>=S.length&&(w.style.display="none",h.style.display="inline-block")}function B(){document.querySelectorAll(".project__item").forEach((o,r)=>{r>=3&&o.remove()}),l=0,w.style.display="inline-block",h.style.display="none",document.querySelector(".load__more").focus()}const M="https://portfolio-js.b.goit.study",T="/api/reviews",L=document.querySelector(".reviews__swiper-list"),G=new j(".reviews__swiper",{modules:[x,C],keyboard:{enabled:!0},navigation:{nextEl:".swiper__btn-next",prevEl:".swiper__btn-prev"},speed:400,spaceBetween:32,breakpoints:{320:{slidesPerView:1},1280:{slidesPerView:2,centerInsufficientSlides:!0}}});async function O(){const{data:e}=await k(M+T);return e}function Y(e){return e.map(({author:s,avatar_url:o,review:r})=>`<li class="swiper-slide">
        ...
        </li>`).join("")}O().then(e=>{L.innerHTML=Y(e),G.update()}).catch(e=>{I.show({message:"Reviews not found"}),L.innerHTML=`<li>
                              <p class="p-l">Not found</p>
                            </li>`});const E=/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/,d=document.querySelector(".work-together__form"),c=d.querySelector(".form__email"),p=document.querySelector(".form__svg-check-right"),g=document.querySelector(".form__email-check-wrong"),F=document.querySelector(".work-together__modal-part");c.addEventListener("blur",()=>{if(E.test(c.value))p.style.display="block",c.style.color="var(--text)",g.style.display="none";else{c.style.color="var(--error)",g.style.display="block",p.style.display="none";return}});d.addEventListener("submit",V);function V(e){e.preventDefault();const s=new FormData(d),o=s.get("form-email"),r=s.get("form-textarea");E.test(c.value)&&(z(`${K}/requests`,o,r).then(t=>{const n=`
